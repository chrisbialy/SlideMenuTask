...
<html lang="en">
  <head>
    ...
    <![endif]-->
      ...
      #topContainer{
   			background-image:url("register.jpg") !important;
   		   		}
      </style>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
     ...
     <li class="nav-item d-none d-lg-block">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" style="color: #1891F2">Zarejestruj Się</a>
      </li>
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
         ...
         <div class="hexagon_img DivSpace2">
			...
			<form  method="post"> 
                ...
                <div id="wrapper">
                    <a href="#" id="btn_account" class="btn btn-basic ">Kontakt</a>
  				 <!-- <input type="submit" name= "submit" class="btn btn-basic " value="UTWÓRZ KONTO">-->
  				</div>
    ...
    <div class="container contentContainer margin_top" align="left"  id="">
  		<div class="row " >
  		
  			<div class="col-md-6 col-md-offset-1" id="topRow">
 			 
 			 <h1 class="marginTop">Rejestracja</h1>
 			 ...
 			 <p class="bold marginTop">Zrejestruj Się</p>
 			 
 			 <form class="form-row" method="post"> 
                 
                 <div class="col">
  					
  				<input type="text" name="name" class="form-control" placeholder="Imię" value="<? echo addslashes($_POST['name']); ?>" />
				...
				<div class="col">
  				...
  				<input type="password" name="password" class="form-control" placeholder="Hasło" value="<? echo addslashes($_POST['password']); ?>" />
  																								  
				</div>

 			 	 
                  <input type="submit" name="submit" value="OK" id="wrapper3" class="btn btn-primary btn-primary2"/> 
